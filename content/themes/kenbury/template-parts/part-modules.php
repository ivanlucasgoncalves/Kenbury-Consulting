...
if( have_rows('page_modules') ):
    ...
    while ( have_rows('page_modules') ) : the_row();
        ...
        if( get_row_layout() == 'features_category' ): 
        	get_template_part('modules/module', 'featuresCategories');
        endif; //Module Full Content
        
        if( get_row_layout() == 'latest_blog' ): 
        	get_template_part('modules/module', 'latestBlog');
        endif; //Module Full Content
